<%-- 
    Document   : warehouse_in_add
    Created on : 2016-11-11, 6:09:17
    Author     : LFeng
--%>
        ...
        <script type="text/javascript">
            ...
            window.onload = function () {
                ...
                $("#saveData").bind("click", function () {
                    ...
                    getDataInterface("warehouseInAddBatch.do", sendBody, function (result) {
                ...
                getDataInterface('orderPlanGet.do', sendBody, function(result) {
                    ...
                    if (obj.status === 0) {
                        ...
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            htmlStr += "<td>";
                            htmlStr += "<a href='javascript:addWarehouseIn(" + i + ")'>添加</a>";
                            htmlStr += "</td>";
                            htmlStr += "</tr>";
                        }
                        htmlStr += "</table>";
