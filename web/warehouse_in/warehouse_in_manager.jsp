<%-- 
    Document   : warehouse_in_manager
    Created on : 2016-11-11, 6:10:46
    Author     : LFeng
--%>
        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                $("#add").bind("click", function () {
                    parent.displayLayer("./warehouse_in/warehouse_in_add.jsp", "成品入库添加", function() {getList("search_form");});
                });
                $("#importData").bind("click", function () {
                    parent.displayLayer("./warehouse_in/warehouse_in_import.jsp", "成品入库导入", function() {getList("search_form");});
                });
            ...
            function getList(formId) {
                ...
                getDataInterface('warehouseInGet.do', sendBody, function(result) {
                    ...
                    if (obj.status === 0) {
                        ...
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            htmlStr += "<td>" + (obj.data[i].warehouseInId ? obj.data[i].warehouseInId : "") + "</td>";
        ...
        <div>
            <div id="message_list">
                <table class="detail_data">
                    <tr class='table_header'><td>序号</td><td>品名</td><td>件号</td><td>入库时间</td><td>数量</td><td>操作</td></tr>
                </table>
            </div>
