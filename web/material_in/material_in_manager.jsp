        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                $("#add").bind("click", function () {
                    parent.displayLayer("./material_in/material_in_add.jsp", "原材料入库录入", function() {getList("search_form");});
                });
                $("#importData").bind("click", function () {
                    parent.displayLayer("./material_in/material_in_import.jsp", "原材料入库导入", function() {getList("search_form");});
                });
