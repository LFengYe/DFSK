        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                $("#importData").bind("click", function () {
                    parent.displayLayer("./base/product_init_import.jsp", "导入成品期初", function(){getBaseInfoList("search_form");});
                });
            ...
            function getBaseInfoList(formId) {
                ...
                getDataInterface('productInitGet.do', sendBody, function(result) {
                    ...
                    if (obj.status === 0) {
                        ...
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            htmlStr += "<td>" + (obj.data[i].productInitId ? obj.data[i].productInitId : "") + "</td>";
