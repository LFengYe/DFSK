            ...
            window.onload = function () {
                ...
                $("iframe").bind("load", function () {
                    ...
                    if (obj.status === 0) {
                        ...
                        getDataInterface("materialInfoImport.do", JSON.stringify(sendBody), function (result) {
            ...
            <form target="hiddenFrame" class="form-horizontal" id="import_form" enctype="multipart/form-data" method="POST" action="../UploadFile">
                ...
                <div class="form-group-sm form-group">
                    <div class="col-sm-offset-2 col-sm-9 function">
                        ...
                        <a class="btn btn-default" id="loadTemplate" href="原材料基础信息导入模板.xls" target="_blank">下载模板</a>
                    </div>
                </div>
            </form>
