<%-- 
    Document   : material_add
    Created on : 2016-11-11, 6:07:49
    Author     : LFeng
--%>
            ...
            window.onload = function () {
                ...
                $("#addData").bind("click", function () {
                    if (checkInput()) {
                        ...
                        tmp.carModel = obj.data[selectedIndex].carModel;
                        ...
                        /*
                         ...
                         getDataInterface("materialAdd.do", sendBody, function (result) {
                ...
                $("#saveData").bind("click", function () {
                    ...
                    getDataInterface("materialOutAddBatch.do", sendBody, function (result) {
                        var obj = JSON.parse(result);
                        alert(obj.message);
                        if (obj.status === 0) {
                            var index = parent.layer.getFrameIndex(window.name);
...
//                    inputObj = obj.data;
                    if (obj.status === 0) {
                        var htmlStr = "<table class='detail_data'><tr class='table_header'><td>序号</td><td>件号名称</td><td>件号</td><td>车型</td><td>数量</td><td>操作</td></tr>";
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            htmlStr += "<td>";
                            htmlStr += "<a href='javascript:addMaterial(" + i + ")'>添加</a>";
                            htmlStr += "</td>";
                            htmlStr += "</tr>";
                        }
                        htmlStr += "</table>";
                        ...
                        var htmlStr = "<table class='detail_data'><tr class='table_header'><td>序号</td><td>件号名称</td><td>件号</td><td>车型</td><td>单车用量</td><td>操作</td></tr>";
                    ...
                    <tr>
                        <td>
                            <div class="form-group-sm form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="jianHao_input" id="jianHao_input" value="" />
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="form-group-sm form-group">
                                <label for="jianHaoName_input" class="col-sm-4 control-label">品名</label>
                                <div class="col-sm-6">
        ...
        <div>
            <div id="message_list">
                <table class="detail_data">
                    <tr class='table_header'><td>序号</td><td>件号名称</td><td>件号</td><td>车型</td><td>单车用量</td><td>操作</td></tr>
                </table>
            </div>
