        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                $("#add").bind("click", function () {
                    parent.displayLayer("./material_out/material_out_add.jsp", "原材料出库录入", function() {getList("search_form");});
                });
                $("#importData").bind("click", function () {
                    parent.displayLayer("./material_out/material_out_import.jsp", "原材料出库导入", function() {getList("search_form");});
                });
            ...
            function getList(formId) {
                ...
                getDataInterface('materialOutGet.do', sendBody, function(result) {
                    ...
                    if (obj.status === 0) {
                        ...
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            htmlStr += "<td>" + (obj.data[i].materialOutId ? obj.data[i].materialOutId : "") + "</td>";
