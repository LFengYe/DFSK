...
function findDimensions() {
    ...
    if (document.getElementById("right")) {
        document.getElementById("right").style.height = (winHeight - 100) + "px";
    }
    if (document.getElementById("iframe_content")) {
        document.getElementById("iframe_content").style.height = (winHeight - 100) + "px";
    }
}
