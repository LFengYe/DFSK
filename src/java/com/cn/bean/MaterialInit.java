...
public class MaterialInit {
    ...
    public int getMaterialInitId() {
        return materialInitId;
    }

    public void setMaterialInitId(int materialInitId) {
        this.materialInitId = materialInitId;
    }
